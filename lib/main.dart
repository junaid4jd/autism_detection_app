...
void main() async {
  ...
  if (Firebase.apps.length == 0) {
    ...
    if (Platform.isIOS) {
      ...
      await Firebase.initializeApp(
          options: FirebaseOptions(apiKey: 'AIzaSyAcRdaQnsx_d-GWHZKYsKWxQ_iKszwYzRI',
            appId: '1:743009389410:android:e55bbc9ccc4974a02bfa3b',
            messagingSenderId: '743009389410',
            projectId: 'autism-perdiction-app',
            storageBucket:  "autism-perdiction-app.appspot.com",
          )
      );
    }
